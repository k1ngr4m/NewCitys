...
def parse_args(parser: argparse.ArgumentParser, args_base):
    ...
    parser.add_argument("--osm_output_limit", type=int, default=config.getint("model", "osm_output_limit"))
    parser.add_argument("--osm_max_retries", type=int, default=config.getint("model", "osm_max_retries"))
    parser.add_argument("--osm_retry_backoff", type=float, default=config.getfloat("model", "osm_retry_backoff"))
    parser.add_argument("--osm_rate_limit_interval", type=float, default=config.getfloat("model", "osm_rate_limit_interval"))
    parser.add_argument("--osm_log_api_calls", type=_as_bool, default=config.getboolean("model", "osm_log_api_calls"))
